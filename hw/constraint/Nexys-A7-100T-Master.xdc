...
set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { io_dat_0[0] }]; #IO_L16P_T2_35 Sch=sd_dat[0]
set_property -dict { PACKAGE_PIN E1    IOSTANDARD LVCMOS33 } [get_ports { io_dat_0[1] }]; #IO_L18N_T2_35 Sch=sd_dat[1]
set_property -dict { PACKAGE_PIN F1    IOSTANDARD LVCMOS33 } [get_ports { io_dat_0[2] }]; #IO_L18P_T2_35 Sch=sd_dat[2]
set_property -dict { PACKAGE_PIN D2    IOSTANDARD LVCMOS33 } [get_ports { io_dat_0[3] }]; #IO_L14N_T2_SRCC_35 Sch=sd_dat[3]
